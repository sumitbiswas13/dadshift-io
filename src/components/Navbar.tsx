    ...
    <nav className="sticky top-0 z-50 border-b border-orange-100 backdrop-blur-xl bg-white/80">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2.5 group">
          <div className="w-10 h-10 bg-orange-500 rounded-xl flex items-center justify-center text-white font-bold text-base shadow-lg shadow-orange-500/25">D</div>
          <span className="font-bold text-gray-900 text-xl" style={{fontFamily:'Playfair Display,serif'}}>
